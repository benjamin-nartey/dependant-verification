  ...
  return (
    <Fragment>
      <div className="absolute right-8 top-16 z-[99]">
        {toggleLogout && (
          <button className="px-4 py-2 z-50 bg-white rounded-md text-base font-medium flex items-center justify-center gap-2 max-md:hidden">
            <AiOutlinePoweroff size={18} /> Logout
          </button>
        )}
      </div>
      <div className="flex bg-[#f4e7ed] max-md:flex-col min-h-screen transition-height duration-75 ease-out overflow-hidden">
                ...
                <div className="max-md:hidden">
                  <div className="flex items-center gap-4 max-md:gap-2">
                    <div
                      ...
                      className={`w-10 h-10 text-center max-md:text-sm rounded-full grid place-items-center font-bold uppercase`}
                    >
                      B
                    </div>
